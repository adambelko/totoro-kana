...
<section>
    <div class="flex justify-center gap-16 mt-24 mb-24">
        ...
        <div class="flex flex-col gap-4 text-left">
            ...
            <p class="max-w-[480px]">Totoro Kana is an open-source project that also survives through your help. Best
                way to support me is by starring the
                <a class="anchor" href="https://github.com/adambelko/totoro-kana" target="_blank">GitHub</a> repo.
                Alternatively, you can also support me through
                <a class="anchor" href="https://ko-fi.com/totorokana" target="_blank">Ko-Fi</a>. Your donations will
                help cover essential costs like hosting and domain services.
            </p>
