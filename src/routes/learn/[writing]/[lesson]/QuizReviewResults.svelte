<script lang="ts">
	...
	let { isHiragana, isReview, incorrectKanaCount, groupName, userProgress, handleRestudy }: Props =
		$props()
...
<div class="flex justify-center gap-4">
	<div class="flex flex-col gap-4 text-center">
		{#if checkForLastReview()}
			...
			<p class="mb-4 text-2xl font-bold">No more reviews at this point.</p>
		{:else if incorrectKanaCount <= 1}
			<p class="text-4xl font-bold">Good job!</p>
			<p class="mb-4 text-2xl font-bold">You passed the review.</p>
			<div class="mb-4">
