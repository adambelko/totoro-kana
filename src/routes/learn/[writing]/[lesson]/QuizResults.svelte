...
<div class="flex justify-center gap-4">
    <div class="flex flex-col gap-4 text-center">
        {#if lastLesson}
            ...
            <span class="text-2xl font-bold mb-10">
        ...
        {:else if incorrectKanaCount <= 1}
            ...
            <span class="text-2xl font-bold mb-10">You passed the lesson.</span>
            <div class="mb-4">
        ...
        {:else}
            ...
            <span class="text-2xl font-bold mb-10">You've made {incorrectKanaCount} mistakes.</span>
            <div>
